...
public class Auditing {
    ...
    @Before("execution(* bankapp.service.TransferService.transfer(..))")
    ...
    @AfterReturning("execution(* bankapp.service.TransferService.transfer(..))")
    public void success(){
        System.out.println("bank successfully transferred amount");
    }
    //After failed transfer service
    @AfterThrowing("execution(* bankapp.service.TransferService.transfer(..))")
